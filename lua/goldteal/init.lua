...
vim.api.nvim_set_hl(0, "Typedef", { fg = oxocarbon.base08, bg = oxocarbon.none })
...
vim.api.nvim_set_hl(0, "@punctuation.delimiter", { fg = oxocarbon.base06, bg = oxocarbon.none })
vim.api.nvim_set_hl(0, "@punctuation.bracket", { fg = oxocarbon.base06, bg = oxocarbon.none })
vim.api.nvim_set_hl(0, "@punctuation.special", { fg = oxocarbon.base06, bg = oxocarbon.none })
...
-- NeoTree
vim.api.nvim_set_hl(0, "NeoTreeFloatTitle", { fg = oxocarbon.base06, bg = oxocarbon.base00 })
